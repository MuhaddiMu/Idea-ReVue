    ...
    <v-layout row wrap>
      <v-flex class="ml-2" xs6 md3>
        <v-card hover max-width="320" class="mx-auto">
          ...
          <v-card-text>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi corrupti iste doloremque aut possimus aspernatur laudantium, repellendus odio, minima asperiores dolores architecto officia rem reiciendis recusandae beatae officiis autem illum.</v-card-text>
